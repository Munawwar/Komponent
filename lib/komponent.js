...
// 3. useDeepState = useState with deep comparison of state
// 4. useDeepMemo = useMemo with deep comparison of dependency array and return value.
// 5. useDeepEffect = useEffect with deep comparison of dependency array.
 ...
 */
export function useDeepMemo(getState, dependencies) {
 ...
 */
export function useDeepState(initialValue) {
  ...
  let hasChanged = false;
  useMemo(() => { hasChanged = true; }, [versionNumber]);
 ...
 * @returns {void}
 */
export function useDeepEffect(func, dependencies) {
